...
graph = ggplot(data = m_data, mapping = aes(x = Year, y = Output, color = Province)) +
  ...
  ggtitle("How Geographic placement within China Affects Output from 1980-2017") + 
...
north_south = ratio(as_tibble(object2), "Heilongjiang_Output", "Hainan_Output")
