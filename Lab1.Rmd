...
object2 = select(object2, "Year", "Shanghai_Output", "Henan_Output", "Sichuan_Output", "Xinjiang_Output")

object2 = gather(object2, "Shanghai_Output", "Henan_Output", "Sichuan_Output", "Xinjiang_Output", key="Province", value="Output")
print(object2)


graph = ggplot(data = object2) +
  geom_point(mapping = aes(x = Year, y = Output, color = Province))
print(graph)
